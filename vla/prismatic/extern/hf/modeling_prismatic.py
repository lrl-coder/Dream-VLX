        ...
        # === Handle Multimodal Forward ===
            ...
            if timestep_embeddings is not None:
                ...
                projected_patch_embeddings = torch.cat(
                    (projected_patch_embeddings, timestep_embeddings), dim=1
                )
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _run_diffusion_prediction(
        ...
        for t in action_head.noise_scheduler.timesteps:
            ...
            projected_patch_embeddings = torch.cat(
                (orig_projected_patch_embeddings, timestep_embeddings), dim=1
            )
    ...
    def _flow_matching_prediction(
        ...
        curr_noisy_actions = action_head.sample_noise((batch_size, NUM_ACTIONS_CHUNK, ACTION_DIM), device)
        orig_projected_patch_embeddings = projected_patch_embeddings.clone()
