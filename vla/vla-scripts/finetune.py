...
class FinetuneConfig:
    ...
    use_discrete_diffusion: bool = False             # If True, uses discrete diffusion (instead of continuous) for action generation
...
def run_forward_pass(
    ...
    if use_diffusion or use_flow_matching:
        ...
        noise, noisy_actions, timestep_embeddings = None, None, None
    ...
    if use_discrete_diffusion:
        ...
        # ground_truth_token_ids = ground_truth_token_ids.masked_fill(output['labels'][:, 1:] == -100, -100)
        #todo we have to do something to make the current_action_mask valid
        pass
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    if cfg.use_flow_matching:
        ...
        noisy_action_projector = init_module(
            NoisyActionProjector, "noisy_action_projector", cfg, device_id, {"llm_dim":  vla.module.llm_dim}, to_bf16=True
        )
